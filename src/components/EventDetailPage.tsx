...
const EventDetailPage: React.FC<EventDetailPageProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-[#0f172a] to-gray-800 min-h-screen text-white">
      {/* Header */}
      ...
      <main className="text-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 pb-8">
          <div className="max-w-4xl mx-auto">
              ...
              event.EVENT_PHOTOS.length > 0 && (
                <div className="relative overflow-hidden rounded-3xl border border-gradient-to-r from-neon-purple/30 via-neon-blue/20 to-neon-purple/30 bg-gradient-to-br from-slate-900/50 via-slate-800/30 to-slate-900/50 backdrop-blur-xl mb-8">
                  ...
                  <div className="relative p-8">
                    ...
                    {/* Photo Grid - matching EventPage layout */}
            ...
            {/* About Section - moved after photos */}
