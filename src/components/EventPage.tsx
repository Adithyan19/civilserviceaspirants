...
const EventPage: React.FC<EventPageProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className="bg-[#0f172a] min-h-screen">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white glow-text hover:text-neon-blue transition-colors">
                  Event Details
                </h1>
              </div>
            </div>
      ...
      {/* Main Content */}
      <main className="bg-gradient-to-br from-gray-900 via-[#0f172a] to-gray-800 min-h-screen text-white">
        {/* Image */}
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">{event.contact_1}</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-green-400">📧</span>
                  <div>
                    ...
                    <span className="text-gray-300">{event.contact_2}</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
